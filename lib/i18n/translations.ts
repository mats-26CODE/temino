...
export const translations = {
  ...
  sw: {
    ...
    "seat.pickSeatsInstructions": "Chagua viti {count} kwenye ramani kwa idadi ya abiria uliyochagua.",
    ...
    "seat.passengerFormAfterSeats": "Gusa viti kwenye ramani kuongeza abiria — fomu za taarifa zitaonekana hapa.",
